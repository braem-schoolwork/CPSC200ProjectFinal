...
//testing InSort
	private static ArrayList<String> TestInsSortMethod()
	{
		String n = "";
		ArrayList<String> arrOfProblems = new ArrayList<String>();
	//setup
		...
		s.initialize(sP);
	//experiment step 1
		s.InSort(arrIN, 0, arrIN.length, Direction.ASCENDING);
	//testing case 1
		for(int i=0; i<arrIN.length; i++)
		{
			if(arrIN[i] != arrOUT[i])
			{
				n = "Insertion Sort Ascending";
				arrOfProblems.add(n);
			}
		}
	//experiment step 2
		s.InSort(arrIN2, 0, arrIN2.length, Direction.DESCENDING);
	//testing case 2
		for(int i=0; i<arrIN2.length; i++)
		{
			if(arrIN2[i] != arrOUT2[i])
			{
				n = "Insertion Sort Descending";
				arrOfProblems.add(n);
			}
		}
		return arrOfProblems;
...
//testing the sort wrapper method
	...
	//testing case 1
		for(int i=0; i<arrIN.length; i++)
		{
			...
			{
				n = "Insertion Sort's Sort wrapper (Ascending)";
				arrOfProblems.add(n);
			}
		}
	//experiment step 2
	...
	//testing case 2
		for(int i=0; i<arrIN.length; i++)
		{
			...
			{
				n = "Insertion Sort's Sort wrapper (Descending)";
				arrOfProblems.add(n);
			}
		}
		return arrOfProblems;
	 ...
	 */
	public static void TestInsSort()
	{
		ArrayList<String> whatTests = new ArrayList<String>();
		String Testname = "Insertion Sort";
		ArrayList<String> g = TestTestPeakUsage();
		ArrayList<String> g2 = TestInsSortMethod();
